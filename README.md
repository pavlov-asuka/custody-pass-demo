...
面向托管业务新人的桌面端学习产品。用户登录后从清算、核算、监督三个学习世界中进入所属条线；当前核算世界已正式开放跨模块核算基础与产品生命周期，以及完整的股票和固定收益核算业务模块。
...
- `ACCOUNTING`：开放；正式内容包含跨模块基础 4 条必修路线、股票模块 4 条必修路线和 4 条非阻挡进阶路线、固定收益模块 4 条必修路线和 5 条非阻挡进阶路线。
