...
面向托管业务新人的桌面端学习产品。用户登录后从清算、核算、监督三个学习世界中进入所属条线；当前核算世界已正式开放岗位导入“站上核算岗”和首条高保真业务路线“股票买卖与成本闭环”。
...
- `ACCOUNTING`：开放；正式路线为 `ACC-LIFE-ROLE-001`“站上核算岗”和 `ACC-STOCK-TRADE-001`“股票买卖与成本闭环”。
- `CLEARING`、`SUPERVISION`：内容建设中，不提供虚假路线或进度。
- “接管一只新产品”仍仅展示为建设中节点；股票业务线不以该节点作为前置。
