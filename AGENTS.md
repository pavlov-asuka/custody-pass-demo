...
- 不自行扩展业务条线、路线或正式内容。阶段 5 跨模块核算基础 4 条、股票模块 8 条、固定收益模块 9 条、期货模块 4 条、估值对账与信息披露模块 5 条、普通货币基金模块 5 条和券结基金模块 4 条路线已经按明确授权完成，统一发布为 `ACCOUNTING_2026.08.8`。券结基金收口为 4 条 REQUIRED 连续主链，不设阶段闸门；自动解析版本切换、复杂权益、迟到重复错配、重跑回滚、多券商、跨市场和场外扩展继续 DEFER。资产模块均以前置“每日核算与结果闭环”为准，“合同终止、清盘与退出”不阻挡资产模块。本批完成后停止，未经明确授权不得启动其他模块。
