...
- 不自行扩展业务条线、路线或正式内容。阶段 5 跨模块核算基础 4 条、股票模块 8 条、固定收益模块 9 条、期货模块 4 条和估值对账与信息披露模块 5 条路线已经按明确授权完成，统一发布为 `ACCOUNTING_2026.08.6`。资产模块均以前置“每日核算与结果闭环”为准，“合同终止、清盘与退出”不阻挡资产模块。固定收益收口为 4 条 REQUIRED 主链与 5 条非阻挡 ADVANCED 支线；期货收口为 4 条 REQUIRED 连续主链；估值对账与信息披露收口为 5 条 REQUIRED 连续主链；均不设阶段闸门。估值披露的多来源口径与尾差重算因缺少完整正常双口径资料包继续 DEFER。本批完成后停止，未经明确授权不得启动其他模块。
