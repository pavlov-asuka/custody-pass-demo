...
- 不自行扩展业务条线、路线或正式内容。阶段 5 跨模块核算基础 4 条、股票模块 8 条和固定收益模块 9 条路线已经按明确授权完成，统一发布为 `ACCOUNTING_2026.08.4`。股票和固定收益均以前置“每日核算与结果闭环”为准，“合同终止、清盘与退出”不阻挡资产模块。固定收益收口为 4 条 REQUIRED 主链与 5 条非阻挡 ADVANCED 支线，不设阶段闸门；债转股/债换股、摊余成本减值、违约债券以及存款与回购不进入本批。本批完成后停止，未经明确授权不得启动期货或其他模块。
