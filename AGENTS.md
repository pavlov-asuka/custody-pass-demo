...
- 不自行扩展业务条线、路线或正式内容。阶段 5 股票模块 8 条路线与跨模块核算基础 4 条路线已经按明确授权完成，统一发布为 `ACCOUNTING_2026.08.3`；股票首条路线以前置“每日核算与结果闭环”为准，“合同终止、清盘与退出”不阻挡资产模块。本批完成后停止。固定收益及其他模块的讨论稿尚未授权制作成正式 JSON 或发布，正式施工必须以经过业务终审的路线资产和明确批次为准。
